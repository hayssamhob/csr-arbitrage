...
export function loadConfig(): ScraperConfig {
  ...
  return {
    ...
    uniswapTimeoutMs: parseInt(process.env.UNISWAP_TIMEOUT_MS || "8000", 10),
    maxStalenessSeconds: parseInt(process.env.MAX_STALENESS_SECONDS || "20", 10),
    ...
    browserRestartOnFailures: parseInt(process.env.BROWSER_RESTART_ON_FAILURES || "3", 10),
