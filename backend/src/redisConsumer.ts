...
export class RedisConsumer extends EventEmitter {
    ...
    private parseStreamMessage(fields: string[]): MarketTick | null {
        ...
        if (obj.payload) {
            try {
                return JSON.parse(obj.payload) as MarketTick;
            } catch {
        ...
        return {
            ...
            effective_price_usdt: obj.effective_price_usdt ? parseFloat(obj.effective_price_usdt) : undefined,
            amount_in: obj.amount_in ? parseFloat(obj.amount_in) : undefined,
            amount_out: obj.amount_out ? parseFloat(obj.amount_out) : undefined,
            gas_estimate_usdt: obj.gas_estimate_usdt ? parseFloat(obj.gas_estimate_usdt) : undefined,
            route: obj.route,
